<div class="form-group">
  ...
  <input class="form-control" id="rek" placeholder="Enter Nama Bank" name="rek" value="<?= set_value("rek", null) ?? $bank->rek ?>">
  <?= form_error("rek", "<div class='danger text-danger'>", "</div>"); ?>
</div>
<div class="form-group">
  <label for="name">Kode Rekening</label>
  <input class="form-control" id="name" placeholder="Enter Kode Rekening" name="name" value="<?= set_value("name", null) ?? $bank->name ?>">
